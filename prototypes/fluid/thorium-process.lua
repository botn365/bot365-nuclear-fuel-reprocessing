data:extend({
	...
	},
	{
	    ...
	    max_temperature = 100,
        icon = "__bot365-nuclear-fuel-reprocessing__/graphics/icons/thorium_processlithium-fluoride.png",
        icon_size = 32,
	    pressure_to_speed_ratio = 0.4,
	    flow_to_energy_ratio = 0.59,
	    order = ""
	...
	},
	{
	    ...
	    max_temperature = 100,
        icon = "__bot365-nuclear-fuel-reprocessing__/graphics/icons/thorium_process/reactor-grade-salt.png.png",
        icon_size = 32,
	    pressure_to_speed_ratio = 0.4,
	    flow_to_energy_ratio = 0.59,
	    order = ""
	},
	{
	    ...
	    max_temperature = 100,
        icon = "__bot365-nuclear-fuel-reprocessing__/graphics/icons/thorium_process/molten-bismuth.png.png",
        icon_size = 32,
	    pressure_to_speed_ratio = 0.4,
	    flow_to_energy_ratio = 0.59,
	    order = ""
	},
	{
	    ...
	    max_temperature = 100,
        icon = "__bot365-nuclear-fuel-reprocessing__/graphics/icons/thorium_process/pre-blancked-salt.png.png",
        icon_size = 32,
	    pressure_to_speed_ratio = 0.4,
	    flow_to_energy_ratio = 0.59,
	    order = ""
	},
	{
	    ...
	    max_temperature = 100,
        icon = "__bot365-nuclear-fuel-reprocessing__/graphics/icons/thorium_process/post-blancked-salt.png.png",
        icon_size = 32,
	    pressure_to_speed_ratio = 0.4,
	    flow_to_energy_ratio = 0.59,
	    order = ""
